...
/**********************************************************************
  ...
  Both keyboard hooks up directly to the port of a 6800 MCU. There are
 ...
 also provided documentation and schematics of the keyboard
   ...
   https://github.com/MattisLind/6800reader
...
ROM_START( alfaskop_s41_kb )
	...
	ROM_LOAD( "kbc_e34066_0000_ic4_e3405970280400.bin", 0x800, 0x20, CRC(f26acca3) SHA1(ac8c607d50bb588c1da4ad1602665c785ebd29b3) )
ROM_END
...
//-------------------------------------------------
//  machine_start -  machine specific startup
//-------------------------------------------------
