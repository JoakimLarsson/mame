...
if (BUSES["VME"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/vme/vme_mock.cpp",
		MAME_DIR .. "src/devices/bus/vme/vme_mock.h",
		...
		MAME_DIR .. "src/devices/bus/vme/vme_fcwfc1.cpp",
		MAME_DIR .. "src/devices/bus/vme/vme_fcwfc1.h",
